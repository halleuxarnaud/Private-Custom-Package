...
class AllDayAppointmentLayout extends StatefulWidget {
  ...
  /// selection.
  final ValueNotifier<SelectionDetailsV2?> repaintNotifier;
...
class _AllDayAppointmentRenderObject extends CustomCalendarRenderObject {
  ...
  ValueNotifier<SelectionDetailsV2?> _selectionNotifier;

  ValueNotifier<SelectionDetailsV2?> get selectionNotifier =>
      _selectionNotifier;

  set selectionNotifier(ValueNotifier<SelectionDetailsV2?> value) {
  ...
  void _updateSelectionDecorationPainter() {
    selectionNotifier.value = SelectionDetailsV2(
